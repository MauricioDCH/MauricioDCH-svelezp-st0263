...
class Peer2PeerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.HandleBootstrap = channel.unary_unary(
                '/peerComms.Peer2PeerService/HandleBootstrap',
        ...
        self.QueryFileList = channel.unary_unary(
                '/peerComms.Peer2PeerService/QueryFileList',
        ...
        self.UploadFile = channel.unary_unary(
                '/peerComms.Peer2PeerService/UploadFile',
        ...
        self.DownloadFile = channel.unary_unary(
                '/peerComms.Peer2PeerService/DownloadFile',
        ...
        self.Ping = channel.unary_unary(
                '/peerComms.Peer2PeerService/Ping',
...
def add_Peer2PeerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'peerComms.Peer2PeerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('peerComms.Peer2PeerService', rpc_method_handlers)
